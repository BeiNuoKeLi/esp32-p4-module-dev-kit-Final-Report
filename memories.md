...
> 
> **最后更新**：2026-06-01（修复 OLED 逐页刷新：Page Addressing Mode 替代 1025 字节单次 I2C 事务）
...
- **报警逻辑**：MQ-135 DO=0 或 光敏 DO=0 → 间歇鸣叫（100ms 鸣 / 500ms 停）
...
├── sensors.c            # 传感器驱动实现 (MQ-135 + DS18B20 + DHT11 + 光敏 + 蜂鸣器)
