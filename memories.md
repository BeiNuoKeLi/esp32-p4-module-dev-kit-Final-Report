...
| DS18B20 DATA 上拉 | 外接 **4.7KΩ** 电阻至 3.3V（待实现） |
...
- [ ] **DS18B20** - 高精度温度传感器（0.0625°C分辨率）
- [ ] **MQ-135** - 空气质量传感器（氨气、硫化物检测）
- [ ] **蜂鸣器报警** - 异常状态声光报警
- [ ] **LED 报警** - 异常状态 LED 指示
...
| 2026-05-27 | 实现 DHT11 驱动 | Agent | 从 51 参考代码移植 |
